...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setLoading(true);
    // TODO: wire up your auth provider (Firebase, Supabase, etc.)
    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p style={{ color: "#666", fontSize: 14, margin: 0 }}>— Benjamin Franklin</p>
        </div>

        {/* Bottom tag */}
        <p style={{ color: "#444", fontSize: 12, margin: 0, lineHeight: 1.6 }}>
          Institutional-quality research.<br />Built in Texas.
        </p>
      </div>
      ...
      >
        <div style={{ width: "100%", maxWidth: 380 }}>
          ...
          <p style={{ fontSize: 11, color: "#bbb", textAlign: "center", marginTop: 32, lineHeight: 1.6 }}>
            Access is restricted to authorized analysts.<br />
