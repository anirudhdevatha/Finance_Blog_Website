...
import { MOCK_REPORTS, type Rating } from "../data/mockData";
...
const ALL_ANALYSTS = [
  "All",
  ...Array.from(new Set(MOCK_REPORTS.map((r) => r.analyst))),
];
...
export default function ResearchArchivePage() {
  ...
  const filtered = useMemo(() => {
    const next = MOCK_REPORTS.filter((report) => {
    ...
    return sorted;
  }, [analyst, rating, search, sector, sort]);
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <button
              ...
              style={{
                ...
                borderRadius: 8,
                border:
                  view === "table" ? "1px solid #185FA5" : "1px solid #E0E0E0",
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 8,
                border:
                  view === "cards" ? "1px solid #185FA5" : "1px solid #E0E0E0",
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <span
                    style={{ fontSize: 14, fontWeight: 600, color: "#185FA5" }}
                  >
